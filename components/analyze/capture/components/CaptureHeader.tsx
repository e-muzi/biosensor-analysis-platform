      ...
      {detectionMode === 'preset' && (
        <Alert severity='info' sx={{ mb: 3 }}>
          <Typography variant='body2'>
            <strong>Preset Mode:</strong> The app will use predefined
            calibration curves for analysis. Make sure your test strip is
            well-lit and positioned clearly in the frame.
          </Typography>
        </Alert>
      )}
    </Container>
