...
export const StripModeBorder: React.FC<StripModeBorderProps> = () => {
  // Calculate border dimensions - A4 landscape ratio (approximately 1.4:1)
  ...
  const borderWidthPercent = 0.8; // 80% of video width for landscape
  const borderHeightPercent = borderWidthPercent / borderAspectRatio;
