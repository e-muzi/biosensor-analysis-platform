      ...
      <Card sx={{ mb: 4 }}>
        <CardContent>
          ...
          <Typography variant='body2' color='text.secondary' sx={{ mb: 3 }}>
            Choose between preset curve-based analysis or physical calibration
            strip analysis.
          </Typography>
      ...
      {(detectionMode === 'preset' || detectionMode === 'strip') && (
        <Card sx={{ mb: 4 }}>
          <CardContent>
            ...
            <Typography variant='body2' color='text.secondary' sx={{ mb: 3 }}>
              Manage the calibration concentrations for each pesticide. These
              values are used for all analyses.
            </Typography>
            <CalibrationSettings />
          </CardContent>
        </Card>
